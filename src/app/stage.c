...
void initStage(void)
{
  ...
  enemyBulletTexture = loadTexture("resources/gfx/enemyBullet.png");
  bulletTexture = loadTexture("resources/gfx/bullet.png");
  playerTexture = loadTexture("resources/gfx/player.png");
...
static void resetStage(void)
{
  ...
  loadMusic("resources/snd/music.wav");
